<template>
    <div class="">
        <p class="mb-4">This chart shows the total performed, and average amounts submitted and paid, per procedure, for the selected state.</p>
...
export default {
    ...
    methods: {
        applyFilters() {
            ...
            axios.get('/api/combinedChartForState', {
                params: {
